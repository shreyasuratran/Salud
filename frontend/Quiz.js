...
const QuizPage = () => {
    ...
    const questions = [
...

        {
            ...
            options: ['Italian', 'Asian', 'Mediterranean', 'Other'],
...

        {
            ...
            options: ['1 meal, no snacks', '2 meals, 1-2 snacks', '3 meals, no snacks', 'Other'],
...
const styles = StyleSheet.create({
    ...
    input: {
        ...
        backgroundColor: "#000000", // Input background color
